...
<head>
  ...
  <title><?= ucwords($global->headline)?> | SIMRM</title>
  ...
  <script src="<?= base_url();?>asset/plugins/bootstrap-notify/bootstrap-notify.js"></script>
	...
	<script type="text/javascript" src="<?= base_url();?>asset/plugins/datatables/datatables.min.js"></script>  
	<!--
            ...
            <li class="<?php if($global->menu==$menu->menu_nama){echo 'active';}?> treeview">
              ...
              <ul class="treeview-menu">
                <?php foreach($menu->submenu AS $submenu):?>
                  ...
                  <!---->
                   <li class="<?php if($global->menu_submenu==$submenu->menu_nama){echo 'active';}?>"><a href="<?= site_url($submenu->menu_link)?>"><i class="<?= $submenu->menu_ikon?>"></i> <?= ucwords($submenu->menu_nama)?></a></li>
