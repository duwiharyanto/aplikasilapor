...
<body class="hold-transition " style="background-image: url(<?=base_url('asset/dist/img/background.jpg')?>); width:100%;height:100%;background-size: cover;">
<div class="container" >
  <section class="content">
    <div class="row" style="margin-top:50px">
      ...
      <div style="color:black;" class="col-sm-6 hidden-xs">
        <h1><i class="fa fa-book"></i> Rekam Medis</h1>
        ...
        <p style="color:black;font-size:16px"><b>Email : </b><a style="color:black" href="haryanto.duwi@gmail.com" >haryanto.duwi@gmail.com</a><br>
